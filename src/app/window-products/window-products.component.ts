...
@Component({
    selector: 'window-products',
    templateUrl: './window-products.component.html',
    styleUrls: ['./window-products.component.css']
})
export class ProductsWindowComponent implements OnInit {
