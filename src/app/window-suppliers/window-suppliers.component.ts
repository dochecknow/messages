...
@Component({
    selector: 'window-suppliers',
    templateUrl: './window-suppliers.component.html',
    styleUrls: ['./window-suppliers.component.css']
})
export class SuppliersWindowComponent implements OnInit {
